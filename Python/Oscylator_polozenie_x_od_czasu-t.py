...
line.set_label('x(t) - rozwiązanie dokładne')
line2.set_label('x(t) - metoda Eulera')
line3.set_label('x(t) - metoda Pośrednia')
line4.set_label('x(t) - metoda Verleta')
line5.set_label('x(t) - metoda Beemana')
ax.legend()
